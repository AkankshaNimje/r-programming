...
directory <-getwd()
directory
setwd("C:/Users/DELL/Desktop/NEW R")
...
write.csv(x=mtcars, file='C:/Users/DELL/Desktop/NEW R/mtcars4.csv', row.names = F)
...
# Method 2:
c_1 <- read.csv("data/mtcars2.csv")
View(c_1)

newmtcars1 = read.csv(file='C:/Users/DELL/Desktop/NEW R/mtcars4.csv')
head(newmtcars1)
#no car names